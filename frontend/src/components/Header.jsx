...
const Header = () => {
    ...
    return (
        <header className="bg-red-200 text-white">
            <div className="container mx-auto flex flex-wrap p-5 flex-col md:flex-row items-center h-40">
                <a className="flex title-font font-medium items-center mb-4 md:mb-0" href="/">
                    ...
                    <span className="ml-3 text-xl text-black hover:text-white">Dulce Rosita</span>
                </a>
                <nav className="md:ml-auto flex flex-wrap items-center text-base justify-center">
                    ...
                    {!token && (
                        <>
                            <Link to="/login" className="mr-5 text-black hover:text-pink-500">
                                Iniciar Sesión
                            </Link>
                            <Link to="/register" className="mr-5 text-black
                            hover:text-pink-500">
                                Registrarse
                            </Link>
                        </>
